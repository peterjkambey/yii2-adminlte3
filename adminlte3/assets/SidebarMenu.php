...
class SidebarMenu extends \yii\widgets\Menu
{
    ...
    public function run()
    {
        ...
        if (isset($this->items['items'])) {
            echo Html::tag('nav', Html::tag('ul', $this->renderItems($items), [
